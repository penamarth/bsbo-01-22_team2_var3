...
Doctor -> Shedule: Врач обращается к расписанию с реузультатами приема пациента addRecordResults(patient, doctor, results)
...
MedicalRecord -> Shedule: Запись обращается к расписанию с уведомлением об успешном вводе данных alert(is_ok)
Shedule -> Doctor: Расписание оповещает врача об успешном вводе данных message(is_ok)
